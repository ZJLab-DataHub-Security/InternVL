...
class CustomTrainer(Trainer):
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> torch.Tensor:
        ...
        # print(f"----fwj---in step{self.steps},memory allocate:{torch.cuda.memory_allocated() / 1024**3} GB, peak is {torch.cuda.max_memory_allocated() / 1024**3} GB,reserved is :{torch.cuda.memory_reserved() / 1024**3} GB")
        self.steps += 1
        return res
